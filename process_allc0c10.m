...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [pr_ls_period(ii),pr_wave_period(ii),pr_acf_period(ii),pr_hht_period(ii),pr_ls_snr(ii),pr_wave_snr(ii),pr_acf_snr(ii),pr_hht_snr(ii)] = calc_periods(ttime,fflux,z(ii),'K2PROJECT');
...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [e_ls_period(ii),e_wave_period(ii),e_acf_period(ii),e_hht_period(ii),e_ls_snr(ii),e_wave_snr(ii),e_acf_snr(ii),e_hht_snr(ii)] = calc_periods(ttime,fflux,z(ii),'K2EVEREST');
...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [sc_ls_period(ii),sc_wave_period(ii),sc_acf_period(ii),sc_hht_period(ii),sc_ls_snr(ii),sc_wave_snr(ii),sc_acf_snr(ii),sc_hht_snr(ii)] = calc_periods(ttime,fflux,z(ii),'K2SC');
...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [scp_ls_period(ii),scp_wave_period(ii),scp_acf_period(ii),scp_hht_period(ii),scp_ls_snr(ii),scp_wave_snr(ii),scp_acf_snr(ii),scp_hht_snr(ii)] = calc_periods(ttime,fflux,z(ii),'K2SC-P');
...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [ff_ls_period(ii),ff_wave_period(ii),ff_acf_period(ii),ff_hht_period(ii),ff_ls_snr(ii),ff_wave_snr(ii),ff_acf_snr(ii),ff_hht_snr(ii)] = calc_periods(ttime,fflux,z(ii),'K2SFF');
...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [fg_ls_period(ii),fg_wave_period(ii),fg_acf_period(ii),fg_hht_period(ii),fg_ls_snr(ii),fg_wave_snr(ii),fg_acf_snr(ii),fg_hht_snr(ii)] = calc_periods(ttime,fflux,z(ii),'K2SP');
